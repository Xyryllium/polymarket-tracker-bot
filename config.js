...
const STOP_LOSS_CHECK_INTERVAL_MS = Number(
  process.env.STOP_LOSS_CHECK_INTERVAL_MS ?? 120000
);
const STOP_LOSS_MIN_TIME_SINCE_ENTRY_MS = Number(
  process.env.STOP_LOSS_MIN_TIME_SINCE_ENTRY_MS ?? 300000
);
const STOP_LOSS_WEBSOCKET_MARKET_FILTER = process.env
...
const ADD_HIGH_CONFIDENCE_ENABLED =
  process.env.ADD_HIGH_CONFIDENCE_ENABLED === "true";
const ADD_HIGH_CONFIDENCE_MIN = Number(
  process.env.ADD_HIGH_CONFIDENCE_MIN ?? 0.8
);
const ADD_HIGH_CONFIDENCE_MAX = Number(
  process.env.ADD_HIGH_CONFIDENCE_MAX ?? 0.9
);
const ADD_HIGH_CONFIDENCE_SIZE_USD = Number(
  process.env.ADD_HIGH_CONFIDENCE_SIZE_USD ?? 2
);
const USE_HALF_SIZE_INITIAL_TRADES =
  process.env.USE_HALF_SIZE_INITIAL_TRADES === "true";
